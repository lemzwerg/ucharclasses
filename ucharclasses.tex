...
\begin{document}
  ...
  \section{Package options and Unicode blocks}
    ...
    The following Unicode blocks are available for use in transition rules (corresponding to Unicode version 17.0), as well as for use as package options when you want ucharclasses to only load those classes that you know are used in your document.

    Starting with XeTeX version 0.99994 (available in TeXLive 2016), the number of \textbackslash XeTeXcharclass registers was extended from 256 to 4096; some not so important blocks (which is of course a highly subjective classification) are thus provided only for this and newer versions; in the list below, those blocks are put into parentheses.
    ...
    \begin{multicols*}{2}
      \begin{itemlist}
        ...
        \item CJKUnifiedIdeographsExtensionJ
        ...
        \item (MiscellaneousSymbolsSupplement)
        ...
        \item (TangutComponentsSupplement)
